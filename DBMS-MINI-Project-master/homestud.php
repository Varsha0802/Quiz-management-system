    ...
    <div style="background-color: #042A38;height: auto;">
        ...
        <?php 
            ...
            if($res)
            {
                ...
                echo "<table id=\"sc\"><thead><tr><td>Quiz Title</td><td>Score Obtained</td><td>Max Score</td><td>Remarks</td></tr></thead>";
                while ($row = mysqli_fetch_assoc($res)) {                
            ...
            if($res)
            {
                ...
                echo "<table id=\"le\"><thead><tr><td>Quiz Title</td><td>Score</td><td>Max Score</td><td>Student name</td><td>Student Mail ID</td></tr></thead>";
                while ($row = mysqli_fetch_assoc($res)) {                
